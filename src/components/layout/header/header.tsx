...
export default function Header() {
  return (
    <header className="group/header fixed inset-x-0 z-[99] py-2 mx-auto px-4 sm:px-6 lg:px-16 2xl:px-0 bg-linear-to-b from-black via-black/50 to-transparent">
      ...
      <div className="relative flex-1 max-w-[1440px] flex items-center mx-auto">
        <div className="flex flex-1 my-2 items-center gap-4">
          <HeaderLogo />
          <HeaderNav />
        </div>
        <AsideMobileMenu />
