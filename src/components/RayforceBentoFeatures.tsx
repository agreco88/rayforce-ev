...
export function RayforceBentoFeatures() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          <div className="relative lg:row-span-2">
            ...
            ajuste metodologico en el calculo del costo promedio equivalente que
            se va ir graduando para nosotros esta es una medida que no tiene un
            componente fiscal este es un ajuste metodologico en el calculo del
            costo promedio equivalente que se va ir graduando'
