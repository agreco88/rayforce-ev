                    ...
                    <AnimatePresence>
                      {isOpen && (
                        <motion.div
                          ...
                          onMouseLeave={handleLeave}
                        >
                          <div className="rounded-xl border border-white/10 bg-neutral-950/95 backdrop-blur-xl shadow-[0_8px_40px_rgba(0,0,0,0.6)] p-1">
                            {item.dropdown!.map((d, di) => (
                              <Link
                                key={di}
                                href={d.href}
                                className="flex items-center px-3 py-2 rounded-lg text-sm text-neutral-300 hover:text-white hover:bg-white/5 transition-colors duration-150"
                              >
                                {d.label}
                              </Link>
                            ))}
